...
const resources = {
  en: {
    translation: {
      ...
      "Total Principle": "Total Principle", "Total Daily Expense": "Total Daily Expense",
      ...
      // Reports
      "Principle": "Principle", "Direct Income": "Direct Income", "Daily Expense": "Daily Expense",
  ...
  hi: {
    translation: {
      ...
      "Principle Amount": "प्रिंसिपल राशि",
      "Cash": "नकद", "Online": "ऑनलाइन", "₹ Amount": "₹ राशि", "Detail (Optional)": "विवरण (वैकल्पिक)",
      "Total Principle": "कुल सेल", "Total Daily Expense": "कुल दैनिक खर्च",
      ...
      // Reports
      "Principle": "सेल", "Direct Income": "डायरेक्ट इनकम", "Daily Expense": "दैनिक खर्च",
